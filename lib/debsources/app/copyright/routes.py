...
# 403 and 404 errors
bp_copyright.errorhandler(403)(lambda e: (ErrorHandler()(e, http=403), 403))
bp_copyright.errorhandler(404)(lambda e: (ErrorHandler()(e, http=404), 404))
...
bp_copyright.add_url_rule(
    ...
    view_func=PackageVersionsView.as_view(
        "api_cp_versions", render_func=jsonify, err_func=ErrorHandler(mode="json")
    ),
)
...
bp_copyright.add_url_rule(
    ...
    view_func=SearchFileView.as_view(
        "api_file", render_func=jsonify, err_func=ErrorHandler(mode="json")
    ),
)
