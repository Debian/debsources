...
class PatchesTestCase(DebsourcesBaseWebTests, unittest.TestCase):
    ...
    def test_package_summary(self):
        ...
        self.assertIn(b'<a href="/src/beignet/1.0.0-1/debian/patches/series/">',
                      rv.data)
    ...
    def test_file_deltas_links(self):
        rv = self.app.get('/patches/beignet/1.0.0-1/')
        self.assertIn(b'<a href="/src/beignet/1.0.0-1/src/cl_utils.h/">',
                      rv.data)
    ...
    def test_bts_link(self):
        ...
        self.assertIn(b'<a href="https://bugs.debian.org/672479">#672479</a>',
                      rv.data)
        # test no bug
    ...
    def test_pagination(self):
        ...
        self.assertIn(b'<a href="' + base_url_bytes + b'?page=1">&laquo; Previous</a>',
                      rv.data)
        rv = self.app.get(base_url + '?page=1')
        self.assertNotIn(b'<a href=' + base_url_bytes + b'?page=2>Next &raquo;</a>',
                         rv.data)
